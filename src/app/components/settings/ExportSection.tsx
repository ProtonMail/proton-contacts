...
const ExportSection = () => {
    ...
    return (
        <>
            <Alert>
                {c('Info')
                    .t`We need to locally decrypt your contacts before you can export them. At the end of the process, a VCF file will be generated and you will be able to download it.`}
            </Alert>
            <div className="mb1">
